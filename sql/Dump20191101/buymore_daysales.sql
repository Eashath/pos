...
CREATE TABLE `daysales` (
  ...
  `nosales` int(5) DEFAULT NULL,
  `daytotal` double(10,2) DEFAULT NULL,
  PRIMARY KEY (`date`)
...
INSERT INTO `daysales` VALUES ('2019-10-10',3,21310.50),('2019-10-11',4,7905.50),('2019-10-28',0,0.00),('2019-10-29',9,3150.00),('2019-10-30',3,822.00),('2019-10-31',0,0.00),('2019-11-01',4,5525.00);
